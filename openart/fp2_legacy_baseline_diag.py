...
MODEL_CANDIDATES = ("/sd/mobilenet.tflite", "mobilenet.tflite")
LABEL_CANDIDATES = (
    "/sd/labels_animal_fruits_traffic.txt",
    "labels_animal_fruits_traffic.txt",
)
...
print("FP_BUILD id=%d mode=LEGACY_BASELINE load_to_fb=1 probe=UART5/12/11 period=%dms" % (FP_BUILD_ID, FP_PROBE_PERIOD_MS))
