...
while True:
    ...
    need_map_refresh = need_full_map
    ...
    if need_map_refresh:
        ...
        if DEBUG_PRINT_MAP_ON_FULL and ((not map_cache_ready) or
                time.ticks_diff(now_ms, last_openmv_map_dump_ms) >= OA_MAP_DUMP_PERIOD_MS):
            print_map_debug(out)
