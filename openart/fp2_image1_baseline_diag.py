...
MODEL_CANDIDATES = ("/sd/smartcar_class_model_qat_1.tflite", "smartcar_class_model_qat_1.tflite")
LABEL_CANDIDATES = (
    "/sd/model_labels.txt",
    "model_labels.txt",
)
...
print("FP_BUILD id=%d mode=IMAGE1_BASELINE load_to_fb=1 probe=UART5/12/11 period=%dms" % (FP_BUILD_ID, FP_PROBE_PERIOD_MS))
